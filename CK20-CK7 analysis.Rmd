...
col.Water <- ifelse(allClin.ordered.os$neoadjuvant == "Y", "#BC5A42", "#009296")
barplot(allClin.ordered.os$time_fu_os, col=col.Water, border=col.Water, space=0.5,
main = "Overall survival", ylab="survival [days]",
cex.axis=1.0, cex.lab=1.0, legend.text=c("Neoadjuvant","Chemonaive"),
args.legend=list(fill=c("#BC5A42","#009296"), border=NA, cex=0.9))

# progression-free + colours for chemotherapy Y/N
col.Water <- ifelse(allClin.ordered.prog$neoadjuvant == "Y", "#BC5A42", "#009296")
barplot(allClin.ordered.prog$time_fu_prog, col=col.Water, border=col.Water, space=0.5,
main = "Progression-free survival", ylab="time to progression [days]",
cex.axis=1.0, cex.lab=1.0, legend.text=c("Neoadjuvant","Chemonaive"),
args.legend=list(fill=c("#BC5A42","#009296"), border=NA, cex=0.9))

# overall survival + colours for % replacement growth pattern
col2.Water <- ifelse(allClin.ordered.os$replacement_percent >= 85, "#BC5A42", ifelse(allClin.ordered.os$replacement_percent <= 5, "#009296", "#F8B195"))
barplot(allClin.ordered.os$time_fu_os, col=col2.Water, border=col2.Water, space=0.5,
main = "Overall survival", ylab="survival [days]",
cex.axis=1.0, cex.lab=1.0, legend.text=c("> 85 % replacement","5 - 85 % replacement", "< 5 % replacement"),
args.legend=list(fill=c("#BC5A42","#F8B195", "#009296"), border=NA, cex=0.9))

# progression-free survival + colours for % replacement growth pattern
col2.Water <- ifelse(allClin.ordered.prog$replacement_percent >= 85, "#BC5A42", ifelse(allClin.ordered.prog$replacement_percent <= 5, "#009296", "#F8B195"))
barplot(allClin.ordered.prog$time_fu_prog, col=col2.Water, border=col2.Water, space=0.5,
main = "Prodression-free survival", ylab="time to progression [days]",
cex.axis=1.0, cex.lab=1.0, legend.text=c("> 85 % replacement","5 - 85 % replacement", "< 5 % replacement"),
args.legend=list(fill=c("#BC5A42","#F8B195", "#009296"), border=NA, cex=0.9))
```